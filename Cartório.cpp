...
int registro() //Funçãa responsável por cadastrar os usuários no sistema
{
	//Início criação de variáveis/string(conjunto de variáveies)
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	char cargo[40];
	//Final criação de variáveis/string(conjunto de variáveies)
	
	printf("Digite o CPF a ser cadastrado: "); //Coletando informaçõo do usuário
	scanf("%s", cpf); //%s refere-se a string
	
	strcpy(arquivo, cpf); // Responsável por copiar o valor das string´s
